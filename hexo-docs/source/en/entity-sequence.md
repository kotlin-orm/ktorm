...
These two functions provide the feature of joining the sequence elements to strings, and their usages are also the same as the corresponding ones of `kotlin.Sequence`. The following code joins all the employees' names to a string: 
